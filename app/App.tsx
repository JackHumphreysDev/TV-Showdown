...
export default function App() {
  ...
  const addItem = (item: Partial<Item>) => perform(async () => {
    ...
    setManualTitle(''); setQuery(''); setSearchResults([]); setWatchlistTab('want'); setCataloguePage(0); setCatalogueTotalPages(0); if (groupId) await refreshGroup(token!, groupId);
  });
