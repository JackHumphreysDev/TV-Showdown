...
export type Item = { id: string; title: string; kind: Kind; year?: number | null; tmdbId?: number | null; posterPath?: string | null; overview?: string | null; note?: string | null; status: Status; profileId?: string; accountId?: string };
export type Group = { id: string; name: string; region: string; role: string; memberCount?: number; members?: Member[]; watchlists?: Item[] };
export type Result = { id: string; title: string; kind: Kind; year?: number | null; tmdbId?: number | null; posterPath?: string | null; overview?: string | null; profile_name: string; state: string };
