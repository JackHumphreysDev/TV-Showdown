...
export type HistoryRow = { id: string; state: string; createdAt: string; winnerName: string; title: string; kind: Kind; year?: number; posterPath?: string | null; overview?: string | null; resultState: string };
