...
console.log('API smoke test passed: separate accounts, profile colours, invite, UK group, watchlists, eligible series, fair spin, idempotency and shared acceptance.');
